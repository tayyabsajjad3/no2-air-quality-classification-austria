...
| T4.4 DAMAP/TUWRD export and publish | External/manual | Requires the final DMP PDF from T4.2 and final maDMP JSON from T4.3. Per the course-team clarification, only one person needs access to the DMP Tool record as long as all group members are listed as contributors. The publication step is manual in DAMAP/TUWRD. |
...
| T4.3 Export and finalise maDMP | External/manual | Requires export from the TU Wien DMP Tool. Per the course-team clarification, all group members should be listed as contributors, but only one person needs direct access to the DMP Tool record. |
...
3. Export the final DMP PDF and maDMP JSON from the TU Wien DMP Tool. Only one person needs record access, but all four group members must be listed as contributors.
