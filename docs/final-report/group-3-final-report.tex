...
\textbf{Report status.} This draft completes the report material for Owner A, Owner B, and Owner C. Owner D still needs to add their final contribution text and confirmation entries before the final PDF is submitted to TUWEL as \texttt{group-3-final-report.pdf}.
...
\bottomrule
\end{longtable}
\textbf{Sign-off chain:} Owner C confirmed by Owner D --- \pending
